...
<body>
    ...
    <a href="{{ url('/') }}" class="mt-6 inline-block px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Go to Home</a>
    <svg id="monkey_404" viewBox="0 0 800 480">
        ...
        <g id="sword">
            ...
            <polygon id="sword_blade" class="st13"
