<x-app-layout>
                                ...
                                @foreach($projects as $project)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($project->url)
                                                <a href="{{ $project->url }}" target="_blank" class="text-blue-600 hover:text-blue-900">{{ $project->url }}</a>
                                            @else
                                                N/A
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <button
                                                @click="$dispatch('open-modal', { id: {{ $project->id }}, title: '{{ $project->title }}' })"
    ...
    <div x-data="{ open: false, projectId: null, projectTitle: '' }"
        @open-modal.window="open = true; projectId = $event.detail.id; projectTitle = $event.detail.title" x-show="open"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Are you sure you want to delete the project "<span x-text="projectTitle"></span>"? This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
